...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		//향상된 for문
		for( Integer num : iSet) {// 원래 for는 범위를 조절할 수 있었다. i값을 2칸씩 옮긴다던지.. 이건 끝까지 도는거임. 순서가 없으니까 얘 규칙대로 다 돎. 
			//':' 뒤쪽에는 돌아야하는 주소 통채로 넣어줌. 반복해야하는 애.(주소를 준거임). 얘는 하나씩 출력할 수 있음. 동시에 한꺼번에 출력못함.앞에는 돌때 한번에 일해야하는걸 num이라는 이름을 가진 것에 담아서 하나씩 하나씩 주소 넣어서 할거임 
